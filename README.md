...
Init
```
aaronetworkd init FIVETECH --chain-id aaronetwork
```
Genesis
```
...
{"@type":"/cosmos.crypto.ed25519.PubKey","key":"dqhVE3QHjsoYq8e/Pf4rZ28ea+6z7DrEkuxi3YTeYK8="}
...
{
  "pubkey": {"@type":"/cosmos.crypto.ed25519.PubKey","key":"dqhVE3QHjsoYq8e/Pf4rZ28ea+6z7DrEkuxi3YTeYK8="},
...
curl https://snapshot.vinjan.xyz./aaron/latest.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.aaronetwork
mv $HOME/.aaronetwork/priv_validator_state.json.backup $HOME/.aaronetwork/data/priv_validator_state.json
sudo systemctl restart aaronetworkd && sudo journalctl -u aaronetworkd -f
```
